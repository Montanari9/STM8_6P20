 ...
 520  004d 84            	pop	a
 521  004e 81            	ret
 557                     ; 157 EXTI_TLISensitivity_TypeDef EXTI_GetTLISensitivity(void)
 557                     ; 158 {
 558                     .text:	section	.text,new
 559  0000               _EXTI_GetTLISensitivity:
 561  0000 88            	push	a
 562       00000001      OFST:	set	1
 565                     ; 160     uint8_t value = 0;
 567                     ; 163     value = (uint8_t)(EXTI->CR2 & EXTI_CR2_TLIS);
 569  0001 c650a1        	ld	a,20641
 570  0004 a404          	and	a,#4
 571  0006 6b01          	ld	(OFST+0,sp),a
 573                     ; 165     return((EXTI_TLISensitivity_TypeDef)value);
