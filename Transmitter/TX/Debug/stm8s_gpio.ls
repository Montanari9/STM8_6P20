 ...
 912                     ; 209     return ((BitStatus)(GPIOx->IDR & (uint8_t)GPIO_Pin));
 ...
 931  0017 81            	ret
1009                     ; 219 void GPIO_ExternalPullUpConfig(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, FunctionalState NewState)
1009                     ; 220 {
1010                     .text:	section	.text,new
1011  0000               _GPIO_ExternalPullUpConfig:
1013  0000 89            	pushw	x
1014       00000000      OFST:	set	0
1017                     ; 222     assert_param(IS_GPIO_PIN_OK(GPIO_Pin));
1019                     ; 223     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1021                     ; 225     if (NewState != DISABLE) /* External Pull-Up Set*/
1023  0001 1e07          	ldw	x,(OFST+7,sp)
1024  0003 270a          	jreq	L374
1025                     ; 227         GPIOx->CR1 |= (uint8_t)GPIO_Pin;
...
1033  000f               L374:
1034                     ; 230         GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
