/**
  ...
  * @author Bruno Montanari / STMicroelectronics - Brazil Application Team
  * @version V1.7
  * @date 23-JUN-2010
  ******************************************************************************
  *
...
/**
  ...
  */
#ifdef _COSMIC_
@far @interrupt @nosvf void TIM1_UPD_OVF_TRG_BRK_IRQHandler(void) 
#else /* _RAISONANCE_ */
