...
#define CmpBit(mem,bit)		(mem ^= (char)(1<<bit))
...
/*	PORTS section
 */
volatile char_bit	Paidr	@PA_IDR;
#define	PA0_IDR	Paidr.bit.bit0
#define PA1_IDR	Paidr.bit.bit1
#define PA2_IDR	Paidr.bit.bit2
#define	PA3_IDR	Paidr.bit.bit3
#define PA4_IDR	Paidr.bit.bit4
#define PA5_IDR	Paidr.bit.bit5
#define PA6_IDR	Paidr.bit.bit6
#define PA7_IDR	Paidr.bit.bit7

volatile char_bit	Paodr	@PA_ODR;
#define	PA0_ODR	Paodr.bit.bit0
#define PA1_ODR	Paodr.bit.bit1
#define PA2_ODR	Paodr.bit.bit2
#define	PA3_ODR	Paodr.bit.bit3
#define PA4_ODR	Paodr.bit.bit4
#define PA5_ODR	Paodr.bit.bit5
#define PA6_ODR	Paodr.bit.bit6
#define PA7_ODR	Paodr.bit.bit7

volatile char_bit	Pbidr	@PB_IDR;
#define	PB0_IDR	Pbidr.bit.bit0
#define PB1_IDR	Pbidr.bit.bit1
#define PB2_IDR	Pbidr.bit.bit2
#define	PB3_IDR	Pbidr.bit.bit3
#define PB4_IDR	Pbidr.bit.bit4
#define PB5_IDR	Pbidr.bit.bit5
#define PB6_IDR	Pbidr.bit.bit6
#define PB7_IDR	Pbidr.bit.bit7

volatile char_bit	Pbodr	@PB_ODR;
#define	PB0_ODR	Pbodr.bit.bit0
#define PB1_ODR	Pbodr.bit.bit1
#define PB2_ODR	Pbodr.bit.bit2
#define	PB3_ODR	Pbodr.bit.bit3
#define PB4_ODR	Pbodr.bit.bit4
#define PB5_ODR	Pbodr.bit.bit5
#define PB6_ODR	Pbodr.bit.bit6
#define PB7_ODR	Pbodr.bit.bit7

volatile char_bit	Pcidr	@PC_IDR;
#define	PC0_IDR	Pcidr.bit.bit0
#define PC1_IDR	Pcidr.bit.bit1
#define PC2_IDR	Pcidr.bit.bit2
#define	PC3_IDR	Pcidr.bit.bit3
#define PC4_IDR	Pcidr.bit.bit4
#define PC5_IDR	Pcidr.bit.bit5
#define PC6_IDR	Pcidr.bit.bit6
#define PC7_IDR	Pcidr.bit.bit7

volatile char_bit	Pcodr	@PC_ODR;
#define	PC0_ODR	Pcodr.bit.bit0
#define PC1_ODR	Pcodr.bit.bit1
#define PC2_ODR	Pcodr.bit.bit2
#define	PC3_ODR	Pcodr.bit.bit3
#define PC4_ODR	Pcodr.bit.bit4
#define PC5_ODR	Pcodr.bit.bit5
#define PC6_ODR	Pcodr.bit.bit6
#define PC7_ODR	Pcodr.bit.bit7

volatile char_bit	Pdidr	@PD_IDR;
#define	PD0_IDR	Pdidr.bit.bit0
#define PD1_IDR	Pdidr.bit.bit1
#define PD2_IDR	Pdidr.bit.bit2
#define	PD3_IDR	Pdidr.bit.bit3
#define PD4_IDR	Pdidr.bit.bit4
#define PD5_IDR	Pdidr.bit.bit5
#define PD6_IDR	Pdidr.bit.bit6
#define PD7_IDR	Pdidr.bit.bit7

volatile char_bit	Pdodr	@PD_ODR;
#define	PD0_ODR	Pdodr.bit.bit0
#define PD1_ODR	Pdodr.bit.bit1
#define PD2_ODR	Pdodr.bit.bit2
#define	PD3_ODR	Pdodr.bit.bit3
#define PD4_ODR	Pdodr.bit.bit4
#define PD5_ODR	Pdodr.bit.bit5
#define PD6_ODR	Pdodr.bit.bit6
#define PD7_ODR	Pdodr.bit.bit7

volatile char_bit	Peidr	@PE_IDR;
#define	PE0_IDR	Peidr.bit.bit0
#define PE1_IDR	Peidr.bit.bit1
#define PE2_IDR	Peidr.bit.bit2
#define	PE3_IDR	Peidr.bit.bit3
#define PE4_IDR	Peidr.bit.bit4
#define PE5_IDR	Peidr.bit.bit5
#define PE6_IDR	Peidr.bit.bit6
#define PE7_IDR	Peidr.bit.bit7

volatile char_bit	Peodr	@PE_ODR;
#define	PE0_ODR	Peodr.bit.bit0
#define PE1_ODR	Peodr.bit.bit1
#define PE2_ODR	Peodr.bit.bit2
#define	PE3_ODR	Peodr.bit.bit3
#define PE4_ODR	Peodr.bit.bit4
#define PE5_ODR	Peodr.bit.bit5
#define PE6_ODR	Peodr.bit.bit6
#define PE7_ODR	Peodr.bit.bit7

volatile char_bit	Pfidr	@PF_IDR;
#define	PF0_IDR	Pfidr.bit.bit0
#define PF1_IDR	Pfidr.bit.bit1
#define PF2_IDR	Pfidr.bit.bit2
#define	PF3_IDR	Pfidr.bit.bit3
#define PF4_IDR	Pfidr.bit.bit4
#define PF5_IDR	Pfidr.bit.bit5
#define PF6_IDR	Pfidr.bit.bit6
#define PF7_IDR	Pfidr.bit.bit7

volatile char_bit	Pfodr	@PF_ODR;
#define	PF0_ODR	Pfodr.bit.bit0
#define PF1_ODR	Pfodr.bit.bit1
#define PF2_ODR	Pfodr.bit.bit2
#define	PF3_ODR	Pfodr.bit.bit3
#define PF4_ODR	Pfodr.bit.bit4
#define PF5_ODR	Pfodr.bit.bit5
#define PF6_ODR	Pfodr.bit.bit6
#define PF7_ODR	Pfodr.bit.bit7

volatile char_bit	Pgidr	@PG_IDR;
#define	PG0_IDR	Pgidr.bit.bit0
#define PG1_IDR	Pgidr.bit.bit1
#define PG2_IDR	Pgidr.bit.bit2
#define	PG3_IDR	Pgidr.bit.bit3
#define PG4_IDR	Pgidr.bit.bit4
#define PG5_IDR	Pgidr.bit.bit5
#define PG6_IDR	Pgidr.bit.bit6
#define PG7_IDR	Pgidr.bit.bit7

volatile char_bit	Pgodr	@PG_ODR;
#define	PG0_ODR	Pgodr.bit.bit0
#define PG1_ODR	Pgodr.bit.bit1
#define PG2_ODR	Pgodr.bit.bit2
#define	PG3_ODR	Pgodr.bit.bit3
#define PG4_ODR	Pgodr.bit.bit4
#define PG5_ODR	Pgodr.bit.bit5
#define PG6_ODR	Pgodr.bit.bit6
#define PG7_ODR	Pgodr.bit.bit7
